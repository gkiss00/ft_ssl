...
then
    ...
    test_des 'echo -n "" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef'
    test_des 'echo -n "1" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "1" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "22" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "22" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "333" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "333" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "4444" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "4444" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "55555" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "55555" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "666666" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "666666" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "7777777" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "7777777" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'
    test_des 'echo -n "88888888" | ./ft_ssl des -k ffffffffffffffff -v 0123456789abcdef' 'echo -n "88888888" | openssl des -K ffffffffffffffff -iv 0123456789abcdef'

    test_des 'echo -n "" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "1" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "1" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "22" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "22" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "333" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "333" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "4444" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "4444" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "55555" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "55555" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "666666" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "666666" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "7777777" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "7777777" | openssl des-ecb -K ffffffffffffffff'
    test_des 'echo -n "88888888" | ./ft_ssl des-ecb -k ffffffffffffffff' 'echo -n "88888888" | openssl des-ecb -K ffffffffffffffff'

    test_des 'echo -n "" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "1" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "1" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "22" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "22" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "333" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "333" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "4444" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "4444" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "55555" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "55555" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "666666" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "666666" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "7777777" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "7777777" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
    test_des 'echo -n "88888888" | ./ft_ssl des-cbc -k f1f2fadf589cf403 -v 0123456789abcdef' 'echo -n "88888888" |openssl des-cbc -K f1f2fadf589cf403 -iv 0123456789abcdef'
